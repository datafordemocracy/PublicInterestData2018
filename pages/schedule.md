...
* Deliverables by next Friday: 
  * well-commented scripts for analysis (in adherence with [code review criteria](codereview.html)) -- if it's not in an accessible and reproducible script, we can't use it;
